...
#    Updated: 2022/01/22 12:02:17 by nlouro           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
C_FILES = fractol.c	mlx_driver.c color.c event_handlers.c browse_image.c ft_isdigit.c ft_atoi.c ft_atof.c ft_strncmp.c
